            ...
            <div class="page-rightheader ms-md-auto">
                <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                    <div class="btn-list">
                        ...
                        <a  href="javascript:void(0);" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#adddesignationmodal"><i class="feather feather-plus"></i>  Add Designation</a>
                        @endcan
                    </div>
                </div>
            </div>
                            ...
                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="responsive-datatable">
                                <thead>
                                    <tr>
                                        ...
                                        @if(Gate::check('edit designations') || Gate::check('delete designations'))
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control required-field" placeholder="Add new Designation" >
                                </div>
                            </div>
