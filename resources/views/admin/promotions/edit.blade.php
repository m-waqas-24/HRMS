                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select required id="employe" name="employee" class="form-control form-select" >
                                        ...
                                        <option value="{{ $employe->id }}" {{ $employe->id == $promotion->emp_id ? 'selected' : ''  }}>{{ $employe->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required id="company_id" name="company" onchange="updateBranches()" class="form-control form-select" >
                                        ...
                                        <option value="{{ $company->id }}" {{ $promotion->company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required id="designation" name="designation" class="form-control form-select" >
                                        <option value="">Select Designation </option>
                                        @foreach($designations as $designation)
                                        <option value="{{ $designation->id }}" {{ $designation->id == $promotion->designation_id ? 'selected' : ''  }}>{{ $designation->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control"  placeholder="Enter Promotion Title" name="title" value="{{ $promotion->title }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Promotion Date:</label>
                                    <input required type="date" class="form-control"  placeholder="Enter Training Cost" name="date" value="{{ $promotion->date }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label">Description:</label>
                                    <textarea name="description" class="form-control" placeholder="Description" id="" cols="30" rows="10">{{ $promotion->description }}</textarea>
                                </div>
                            </div>
                        </div>
